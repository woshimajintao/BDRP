...
if(len(sys.argv) > 1):
    ...
    print("else")
    writeAnnotationFiles("test", "/content/drive/MyDrive/Colab Notebooks/BDRP/hand_dataset/test_dataset/test_data")
    writeAnnotationFiles("train", "/content/drive/MyDrive/Colab Notebooks/BDRP/hand_dataset/training_dataset/training_data")
    writeAnnotationFiles("validation", "/content/drive/MyDrive/Colab Notebooks/BDRP/hand_dataset/validation_dataset/validation_data")
